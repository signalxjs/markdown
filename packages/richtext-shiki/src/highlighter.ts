/**
 * `createShikiHighlighter()` — a `CodeHighlighter` (see `@sigx/richtext/dom`) on top of `shiki`,
...
import { plainTokens, type CodeHighlighter, type HighlightedToken } from '@sigx/richtext/dom';
