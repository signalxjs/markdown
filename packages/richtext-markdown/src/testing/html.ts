...
import type { AlignType, Code, Definition, Heading, Image, ImageReference, Link, LinkReference, List, ListItem, Node, Parent, Root, Table, TableRow } from '@sigx/richtext';
