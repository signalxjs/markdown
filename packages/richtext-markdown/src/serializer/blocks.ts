...
import type { Blockquote, Code, Definition, Heading, List, ListItem, Literal, Node, Paragraph, Root, Table, TableRow } from '@sigx/richtext';
import { escapeLabel, longestRun } from './escape.js';
import { PHRASING_TYPES, destination, runRule, serializeInline, serializePhrasing, serializeUnknown, type State } from './inline.js';
