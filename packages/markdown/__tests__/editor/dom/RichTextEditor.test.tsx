...
import { RichTextEditor, createDomMentionPlugin, type RichTextEditorController, type ContainerView } from '@sigx/markdown/editor/dom';
import { createSlashPlugin, markdownPreset, blockSelection, ATOM_CHAR, type EditorPlugin } from '@sigx/markdown/editor';
import { markdownFormat, type Root } from '@sigx/markdown';
